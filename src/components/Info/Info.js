 ...
 Random motivation quote displayed on click it. App has marine design and basic functionality. 
	...
	return (
		<article>
			...
			<p className={style.info} dangerouslySetInnerHTML={{ __html: replaceWithBr() }}></p>
			<div className={style.gitHub}><a href="https://github.com/blossomingiris" target='_blank' rel='noreferrer'><DiGithubAlt className={style.icon_gitHub} /></a></div>
			<div className={style.return}><a href="/" className={style.return_link}>~ back ~</a></div></article>
	)
}
